...
export const ProductTeaserCard = (props: ProductTeaserCardProps) => {
  const {
    ...
    subheadline = "SovetPay — платформа аренды жилья через рекомендации. Арендаторы создают заявки, рекомендатели предлагают варианты за вознаграждение, владельцы находят проверенных жильцов.",
  ...
  return (
    <section className="w-full px-4 sm:px-6 md:px-8 pt-12 sm:pt-14 md:pt-16 pb-6 sm:pb-8">
