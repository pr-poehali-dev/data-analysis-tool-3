            ...
            <div className="px-6 py-6 space-y-4">
                ...
                {user ? (
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      className="w-full text-[#202020] border border-[#202020] rounded-full px-[18px] py-[15px] text-base leading-4 whitespace-nowrap transition-all duration-150 ease-[cubic-bezier(0.455,0.03,0.515,0.955)] hover:rounded-2xl"
                    >
                      Войти
                    </button>
                    <button
              ...
              <div className="border-t border-border pt-4 mt-2">
                <div className="mb-4">
                  ...
                  />
                  <p className="text-sm leading-5 text-muted-foreground max-w-xs mb-3">
                    Аренда жилья через рекомендации — безопасно и выгодно
                  </p>
                  <div className="flex items-center gap-3">
                    <a href={socialLinks.vk} className="w-9 h-9 flex items-center justify-center rounded-full bg-background border border-border text-muted-foreground hover:text-foreground hover:border-foreground transition-colors duration-150" aria-label="VK">
                    ...
                    <a href={socialLinks.telegram} className="w-9 h-9 flex items-center justify-center rounded-full bg-background border border-border text-muted-foreground hover:text-foreground hover:border-foreground transition-colors duration-150" aria-label="Telegram">
                    ...
                    <a href={socialLinks.instagram} className="w-9 h-9 flex items-center justify-center rounded-full bg-background border border-border text-muted-foreground hover:text-foreground hover:border-foreground transition-colors duration-150" aria-label="Instagram">
