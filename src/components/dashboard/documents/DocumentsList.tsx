      ...
      <div className="grid gap-4">
        {documents.map((doc) => (
          <motion.div
            ...
            className="bg-white border border-border rounded-xl p-4 sm:p-6 hover:shadow-md transition-shadow"
          >
              ...
              <div className="flex-1 w-full">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="min-w-0">
                    <h4 className="font-semibold text-foreground text-sm sm:text-base">Договор аренды жилья</h4>
                ...
                <div className="flex flex-wrap items-center gap-3 sm:gap-4 mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-border text-xs text-muted-foreground">
              ...
              <div className="w-full sm:w-auto">
                ...
                <div className="grid grid-cols-2 sm:flex sm:flex-col gap-2">
                  <Button
                    ...
                    className="whitespace-nowrap flex items-center justify-center sm:justify-start"
                  >
                  ...
                  <Button
                    ...
                    className="whitespace-nowrap flex items-center justify-center sm:justify-start text-red-600 hover:text-red-700 hover:bg-red-50"
                  >
