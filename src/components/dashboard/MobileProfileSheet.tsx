...
export const MobileProfileSheet = ({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="md:hidden rounded-t-2xl pb-[calc(env(safe-area-inset-bottom)+16px)] max-h-[85dvh] overflow-y-auto">
        <SheetHeader>
        ...
        <div className="border-t border-border mt-4 pt-3">
          ...
          >
            <span>О сервисе</span>
            <Icon name={isFooterOpen ? "ChevronUp" : "ChevronDown"} size={18} />
          </button>
